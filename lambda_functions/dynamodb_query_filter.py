...
table = dynamoDb.Table('zaichatbotDb2')
...
def lambda_handler(event, context):
    ...
    #message['messageId'] = message.pop('id')
    ...
    #response['messageId'] = response.pop('id')
    ...
    responseFromDynamodb = dynamoTable.query(
    ...
    if message["flowId"]=="START" and message["sessionId"]=="-1":
        responseObject['body'] = json.dumps(responseFromDynamodb['Items'])
    else:
