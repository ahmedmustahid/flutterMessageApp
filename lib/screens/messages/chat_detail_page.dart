...
import 'package:chat/screens/messages/components/appBar.dart';
...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        //  deleteSelectedChats: deleteSelectedChats, //openUpdateMessageSheet: openUpdateMessageSheet,
        //),
  ...
  Widget buildChatList({required List<ChatModel> chatData}) {
    return ListView(
      reverse: true,
